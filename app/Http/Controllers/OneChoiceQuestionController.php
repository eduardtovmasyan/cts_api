...
use App\Http\Requests\CreateOneChoiceQuestionRequest;
use App\Http\Requests\UpdateOneChoiceQuestionRequest;
class OneChoiceQuestionController extends Controller
{
     ...
     * @return \Illuminate\Http\Response
     */
    public function store(CreateOneChoiceQuestionRequest $request)
    {
     ...
     * @return \Illuminate\Http\Response
     */
    public function update(UpdateOneChoiceQuestionRequest $request, $id)
    {
